...
const Breadcrumbs = ({ card, divider, icon, icons, maxItems, navigation, rightAlign, separator, title, titleBottom, ...others }) => {
    ...
    const separatorIcon = separator ? <SeparatorIcon size="1rem" stroke={1.5} /> : <IconTallymark1 size="1rem" stroke={1.5} />;
    ...
    if (main && main.type === 'collapse') {
        ...
        mainContent = (
            <Typography component={Link} sx={linkSX} to="#" variant="subtitle1">
                    ...
                    <Box sx={{ p: 2, pl: card === false ? 0 : 2 }}>
                        ...
                        >
                            ...
                            <Grid item>
                                ...
                                >
                                    <Typography color="inherit" component={Link} sx={linkSX} to="/" variant="subtitle1">
